...
{	
	object weapon;
	set_name("Ñ©ÓòÒõ»ê", ({ "dungeon shade","shade"}) );
	set("class","bonze");
	set("group","icecave_maze");
	set("target_name","Ñ©ÓòÒõ»ê");
	...
	weapon->set_name(WHT"¸²Âú±ùÑ©µÄÄ¾ÕÈ"NOR, ({"staff" }) );
	weapon->set("long","ÕâÊÇÒ»¸ù¸²Âú±ùÑ©µÄÄ¾ÕÈ¡£\n");
	weapon->set("value",0);
	weapon->wield();
	...
	set("long","Ò»ÂÆ¶³ËÀÔÚ±ù¶´Ö®ÈËÔ¹ÄîÄý³ÉµÄÒõ»ê¡£\n");
	set("no_arrest",1);
	set("no_fly",1);
