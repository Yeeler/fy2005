...
{
		object weapon;
        set_name("ÅþÂÞÌì", ({ "pi luotian","pi","luotian" }) );
        set("title",WHT"ÊÀ×ðÃðÜ©Ñ×"NOR);
		set("nickname",MAG"ÍòÀï»ÆÉ³²»¼ûÉ®"NOR);
        set("gender", "ÄÐÐÔ" );
		set("class","shaolin");
